...
import GoogleLoginPagePopup from '../auth/GoogleLoginPagePopup'; // Import Google login component
import AppleLoginPage from '../auth/AppleLoginPage'; // Import Apple login component
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className="card" style={{ border: 'none' }}>
                        ...
                        <div className="social-login-buttons d-flex my-3 justify-content-center">
